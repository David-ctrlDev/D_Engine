...
export const es = {
  ...
  // Editorial-style copy. The masthead label imitates a magazine
  // issue line; footnotes read like a book's spine. Restraint > flash.
  "hero.masthead": "Vol. 01 · Edición de campo",
  "hero.eyebrow": "Para equipos que viven entre datos crudos",
  "hero.headline_a": "Los datos llegan",
  "hero.headline_b": "como vienen.",
  "hero.headline_c": "Salen listos.",
  "hero.subtitle":
    "Conecta tu base de datos o sube un archivo. Un agente lee, perfila, propone y limpia — tú solo apruebas. La salida queda lista para entrenar un modelo o alimentar a un LLM.",
  "hero.flow.before": "Lo que entra",
  "hero.flow.after": "Lo que sale",
  "hero.note.one.num": "i.",
  "hero.note.one.title": "Cualquier fuente",
  "hero.note.one.body": "Postgres, SQL Server, Azure SQL, CSV, Parquet, Excel.",
  "hero.note.two.num": "ii.",
  "hero.note.two.title": "Agente que decide",
  "hero.note.two.body": "Te muestra opciones; tú aceptas o niegas. Nada en silencio.",
  "hero.note.three.num": "iii.",
  "hero.note.three.title": "Listo para ML y LLM",
  "hero.note.three.body": "Tablas de entrenamiento y bundles de contexto, versionados.",
...
export const en: Record<DictionaryKey, string> = {
  ...
  "hero.masthead": "Vol. 01 · Field edition",
  "hero.eyebrow": "For teams that live in raw data",
  "hero.headline_a": "Data lands",
  "hero.headline_b": "as it is.",
  "hero.headline_c": "Leaves ready.",
  "hero.subtitle":
    "Connect a database or drop a file. An agent reads, profiles, proposes and cleans — you just approve. The output is ready to train a model or feed an LLM.",
  "hero.flow.before": "What goes in",
  "hero.flow.after": "What comes out",
  "hero.note.one.num": "i.",
  "hero.note.one.title": "Any source",
  "hero.note.one.body": "Postgres, SQL Server, Azure SQL, CSV, Parquet, Excel.",
  "hero.note.two.num": "ii.",
  "hero.note.two.title": "Agent that decides",
  "hero.note.two.body": "It surfaces options; you accept or decline. Nothing silent.",
  "hero.note.three.num": "iii.",
  "hero.note.three.title": "Ready for ML and LLM",
  "hero.note.three.body": "Training tables and context bundles, versioned.",
